...
# Mock imports for API server to prevent actual import errors
sys.modules["gemini_client"] = MagicMock()
sys.modules["auth"] = MagicMock()
# chat_history, health_profile etc might be imported for real below, so be careful.
# The test imports specific functions from health_profile and password_history.
